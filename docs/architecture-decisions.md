...
Các mục `ARCH-HG-001`–`ARCH-HG-010` trong `docs/architecture.md` vẫn mở. Không ADR nào được chuyển khỏi `PROPOSED` nếu chưa có quyết định của người có thẩm quyền.
